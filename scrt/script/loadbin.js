var prog = crt.Screen.ReadString("\r\n","?", "^C");
var restart_mode = "none";  // mode: restart reboot none

var modhash = new Object();
var modfilename = "D://restart_mode.txt";
function loadfile(filename) {
	...
	f = fso.OpenTextFile(filename, 1); //var ForReading = 1, ForWriting = 2; 
...
if(crt.Screen.MatchIndex != 3 && prog != "") {
	crt.Screen.Send("\3");
