// fiber port up/down without module plugged in problem
...
function bug_check() {
  var ret = crt.Screen.WaitForStrings("HAL-6: Interface eth0/2", 3);
  bug_found = ret == 1;
  return ret == 1;
}
...
init_debug();
while (!bug_check() && do_clean() && cmdreboot() && cmdwait2login());
