...
Sub sample_orders()
    ...
    sh.Range("A2:M2") = Array("1/12/2021", "项目启动预付款", "开发费", "50000", "XXX项目", "L", "1/14/2021", "50000", "", "", "", "", "")
    sh.Range("A3:M3") = Array("1/18/2021", "芯片出货", "license费", "20000", "", "S", "", "20000", "", "10000", "", "10000", "")
    sh.Range("A4:M4") = Array("1/20/2021", "发工资", "工资", "10000", "", "", "", "-10000", "", "", "", "", "")
    sh.Range("A5:M5") = Array("1/21/2021", "补贴", "其他", "5000", "", "", "", "", "-5000", "", "", "", "")
End Sub
